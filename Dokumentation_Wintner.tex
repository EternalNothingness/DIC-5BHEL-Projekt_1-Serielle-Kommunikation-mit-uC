...
\begin{document}
	...
	\section{MAX485}
		...
		\\\includegraphics[width=1\textwidth]{"mx1"}\\
		\includegraphics[width=1\textwidth]{"mx2"}\\ 
		\\\includegraphics[width=1\textwidth]{"mx3"}\\
		\includegraphics[width=1\textwidth]{"mx4"}\\
		\includegraphics[width=1\textwidth]{"mx5"}\\
		\\\includegraphics[width=1\textwidth]{"mx6"}\\
		\includegraphics[width=1\textwidth]{"mx7"}\\
		...
		\subsection{Pin-Beschreibung}
			...
			\\\includegraphics[width=1\textwidth]{"mx8"}\\
		...
		\subsection{Wahrheitstabellen}
			...
			\\\includegraphics[width=1\textwidth]{"mx9"}\\
